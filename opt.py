...
def config_parser(cmd=None):
    ...
    parser.add_argument('--model_name', type=str, default='SMURF')

    # loader options
    parser.add_argument("--batch_size", type=int, default=4096)
    parser.add_argument("--n_iters", type=int, default=40000)
    parser.add_argument("--blur_start", type=int, default=500,
                        help='start iteration to blur the data')
    parser.add_argument("--rm_near_plane", type=int, default=0,
                        help='remove near plane in ray marching')
    ...
    # Kernel Options
    parser.add_argument("--num_warp", type=int, default=8)
    parser.add_argument("--img_embed", type=int, default=32)
    parser.add_argument("--spatial_embed_freq", type=int, default=2)
    parser.add_argument("--embed_dim", type=int, default=64)
    parser.add_argument("--method", type=str, default="euler")
    parser.add_argument("--chrono_view_embed_dim", type=int, default=16)
    parser.add_argument("--adjoint", type=bool, default=False)
    parser.add_argument("--point_float", type=bool, default=False)
    parser.add_argument("--chrono_view", type=bool, default=True)
    parser.add_argument("--res_momentum", type=bool, default=True)
    ...
    parser.add_argument('--focuspoint_scale', type=float, default=1.0)
    parser.add_argument('--radius_scale', type=float, default=1.0)
    parser.add_argument("--tonemapping", type=str, default='gamma', choices=['none', 'gamma', 'learn'])
